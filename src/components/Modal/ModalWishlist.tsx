...
// Define WishlistItem type based on ProductType (subset or full match)
type WishlistItem = ProductType; // Adjust if WishlistContext uses a subset
            ...
            >
              <div className="infor flex items-center gap-5">
                <div className="bg-img">
                  <Image
                    src={product.thumbnails[0] || '/placeholder-image.jpg'} // Added fallback
                    width={300}
                    height={300}
                    alt={product.name}
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <div className="product-price text-title">₹{product.salePrice}.00</div>
              ...
              <div
                ...
                onClick={() => removeFromWishlist(product._id)} // Changed from product.id to product._id
              >
                Remove
              </div>
            </div>
