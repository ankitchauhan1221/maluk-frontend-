                ...
                <div className={`benefit-block ${props}`}>
                    <div className="list-benefit grid items-start md:grid-cols-3 grid-cols-1 xl:gap-[160px] lg:gap-20 gap-10 gap-y-6">
                        <div className="benefit-item flex flex-col items-center justify-center">
                            ...
                            <div className="caption1 text-secondary text-center mt-2">"We believe in skin that feels natural and radiance that shines from within."</div>
                        </div>
                        <div className="benefit-item flex flex-col items-center justify-center">
                            ...
                            <div className="caption1 text-secondary text-center mt-3">"With transparency as our guide and color as our expression, we redefine conventions."</div>
                        </div>
                        <div className="benefit-item flex flex-col items-center justify-center">
